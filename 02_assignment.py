# -*- coding: utf-8 -*-
"""
Created on Sat Sep 19 15:01:28 2020

@author: chitr
"""
'''
Assignment #2
1. Add / modify code ONLY between the marked areas
...
def exercise09():
    ...
    # ------ Place code below here \/ \/ \/ ------
    dogs = []
    url_list=['https://unsplash.com/images/animals/dog',
    'https://dog.ceo/dog-api/',
    'https://www.pexels.com/search/dog/',
    'https://pixabay.com/images/search/puppy/',
    'https://placedog.net/',
    'https://www.shutterstock.com/search/dog',
    'https://www.akc.org/expert-advice/lifestyle/35-perfect-pictures-of-dogs/',
    'https://www.goodhousekeeping.com/life/pets/g3413/cute-dog-pictures/',
    'https://visualhunt.com/photos/dog/',
    'https://www.gettyimages.in/photos/dogs?mediatype=photography&phrase=dogs&sort=mostpopular',
    'https://brightside.me/wonder-animals/the-100-greatest-dog-photos-of-all-time-142555/']
    
    for i in url_list:
        dog_media = r.get(url=i)
